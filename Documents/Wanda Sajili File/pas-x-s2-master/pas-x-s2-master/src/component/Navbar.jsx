				...
				<header className="h-[80px] bg-navigator dark:bg-darkNav flex flex-row items-center justify-between gap-1 hpsk:gap-3 hpk:gap-0 px-2 hpsk:px-3 lg:px-24 xl:px-40 fixed inset-x-0 top-0 shadow-xl z-40 ">
					...
					>
						...
						<div className=" flex flex-col gap-3 ml-5 mt-2">
							...
							<div onClick={() => window.open('//////////////', '_blank')} className="text-[#8b8b8b] dark:text-white dark:hover:text-navigator hover:text-navigator group  flex flex-row items-center gap-4">
								<svg className="fill-[#8b8b8b] group-hover:fill-green-400" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
								...
								<h3 className="font-bold cursor-pointer select-none text-base md:text-xl transition-all duration-150">Logout</h3>
							</div>
						</div>
						<hr className="my-2" />
				...
				>
					<div className="flex items-center gap-3 mb-2">
						...
						<div className=" flex flex-col font-poppins">
							...
							<h2 className=" font-light text-[10px] md:text-sm text-[#8b8b8b]">sajili.wanda@gmail.com</h2>
						</div>
					</div>
					<hr />
					<div className=" flex flex-col gap-3 ml-5 mt-2">
						...
						<div onClick={() => window.open('https://github.com/wandasajili', '_blank')} className="text-[#8b8b8b] dark:text-white dark:hover:text-navigator hover:text-navigator group  flex flex-row items-center gap-4">
							<svg className="fill-[#8b8b8b] group-hover:fill-green-400" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
								<path d="M12 12C15.3137 12 18 9.31371 18 6C18 2.68629 15.3137 0 12 0C8.68629 0 6 2.68629 6 6C6 9.31371 8.68629 12 12 12Z" />
								<path d="M12 13.9991C7.03172 14.0046 3.00553 18.0308 3 22.9991C3 23.5514 3.4477 23.9991 3.99998 23.9991H20C20.5522 23.9991 21 23.5514 21 22.9991C20.9945 18.0308 16.9683 14.0046 12 13.9991Z" />
							</svg>
